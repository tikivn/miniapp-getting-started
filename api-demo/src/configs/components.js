...
const advancedComponents = [
  ...
  },
  {
    ...
    components: [
      ...
      {
        name: 'Alphabet',
        path: '/pages/component/advance/navigation/alphabet/index',
      },
      {
        name: 'Pagination',
...
const flattenComponents = [...flatten(basicComponents), ...flatten(advancedComponents)];

export { advancedComponents, basicComponents, flattenComponents };
