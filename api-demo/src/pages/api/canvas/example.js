...
example.drawImage = function (context) {
  context.save();
  context.drawImage('./tiki-now.jpeg', 0, 0);
  context.restore();
};
...
example.fillText = function (context) {
  ...
  context.setFontSize(10);
  context.fillText('Hello Tiki', 0, 30);
  context.setFontSize(20);
  context.fillText('Hello Tiki', 200, 30);
...
example.createPattern = function(ctx){
  ctx.save();
  const grd = ctx.createPattern('https://salt.tikicdn.com/ts/upload/04/0b/25/a5454fdd79f2f7204d5e8525ed65b452.png', 'repeat');
  ctx.setFillStyle(grd);
  ctx.fillRect(20, 20, 250, 180);
  ctx.restore();
};
